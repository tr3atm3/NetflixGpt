...
const Header = () => {
  ...
  return (
    <div className="absolute flex w-full px-8 py-2 bg-gradient-to-b from-black justify-between items-center">
      <img
        className="w-44"
      ...
      {user && (
        <div className="flex justify-start items-center">
          ...
          <button
            ...
            className="bg-red-500 p-1.5 m-2 text-white font-bold"
          >
            Sign out
          </button>
        </div>
